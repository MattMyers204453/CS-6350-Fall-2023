...
def find_highest_IG_NEW(df, attribute_names, labels, attribute_values):
...
def ID3(df, attribute_names, attribute_values, label_values):
    ...
    feature_with_highest_IG = find_highest_IG_NEW(df, attribute_names, label_values, attribute_values)
...
def ID3_traverse_tree(row, root, attribute_values):
