...
def ID3(df, attribute_names, attribute_values, label_values, current_depth=0, max_depth=5):
    if current_depth == max_depth:
        return Node(isLeafNode=True, feature=None, label=df['label'].mode()[0])
    ...
    for value in attribute_values[feature_with_highest_IG]:
        ...
        # Otherwise, crea
            ...
            subtree = ID3(subset, subAttributes, subAttribute_values, label_values, current_depth + 1, max_depth)
