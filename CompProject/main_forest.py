...
# TRAIN
trees = forest.train(df=df, T=T, attribute_names=attribute_names, attribute_values=attribute_values,
                       label_values=label_values, sample_size=training_sample_size)

# RUN TEST
print("Testing...")
predictions = forest.make_predictions(df=df_test, trees=trees, attribute_values=attribute_values)
